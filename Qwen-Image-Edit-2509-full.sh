...
export WANDB_NAME="${WANDB_NAME:-Qwen-Image-Edit-2509-root-cfg-full}"


# 两阶段拆分训练：阶段 1 预处理缓存，阶段 2 正式训练

CACHE_PATH="./data/Qwen-Image-Edit-2509_lora-full-rank512-split-cache"
OUTPUT_PATH="./train/Qwen-Image-Edit-2509_lora-full-rank512-cfg"
...
#   --dataset_metadata_path dataset_qwen_pe_full.json \
#   --data_file_keys "image,edit_image,ref_gt" \
#   --extra_inputs "edit_image,ref_gt" \
#   --max_pixels 1048576 \
#   --dataset_repeat 1 \
